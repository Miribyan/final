                    ...
                    <form onSubmit={handleSubmit} className="mb-6">
                        <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200">
                            ...
                            <textarea
                                ...
                                className="bg-white px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none"
                                ...
                                <article className="p-6 mb-6 text-base bg-white rounded-lg  ">
                                    <footer className="flex justify-between items-center mb-2">
                                        ...
                                        <button
                                            ...
                                            type="button"
                                            className="inline-flex items-center py-1 px-2 text-xs  text-center text-white bg-red-500 rounded-lg focus:ring-4 focus:ring-primary-200  hover:bg-primary-800"
                                        >
                                            Х
                                        </button>
                                    </footer>
