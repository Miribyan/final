    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between">
            ...
            <button
                ...
                className="inline-flex self-end mr-10 h-fit mb-4 w-fit items-center py-1.5 px-2 text-xs sm:py-2 sm:px-3 md:py-2.5 md:px-4 text-xs text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-primary-200 hover:bg-primary-800"
                type="button"
            >
                {buttonText}
            </button>
