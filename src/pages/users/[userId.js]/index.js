    ...
    return (
        <main className="flex min-h-screen w-full flex-col items-center">
            <div className="flex w-full  justify-between  pb-5 mb-5 w-full ">
                ...
                <Link
                    href={`/new_review`}
                    className="text-md text-gray-900  mx-10 inline-flex items-center py-1.5 px-2 text-xs sm:py-2 sm:px-3 md:py-2.5 md:px-4 text-xs text-center text-white bg-gray-700 rounded-lg focus:ring-4 focus:ring-primary-200 hover:bg-primary-800"
                >
                    + NEW REVIEW
                </Link>
            </div>
